...
docker tag  yolov5-lambda:latest 399705378036.dkr.ecr.us-east-1.amazonaws.com/yolov5-lambda:latest
docker push 399705378036.dkr.ecr.us-east-1.amazonaws.com/yolov5-lambda:latest        
